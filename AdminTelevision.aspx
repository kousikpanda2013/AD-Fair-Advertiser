<%@ Page Title="Admin Television" Language="VB" MasterPageFile="~/AdminMaster.master" AutoEventWireup="false" CodeFile="AdminTelevision.aspx.vb" Inherits="AdminTelevision" %>
...
<div style="background-image: url('images/backgr/c4.jpg'); font-family: Arial, Helvetica, sans-serif; font-size: 18px; color: #FFFFFF; height: auto;">
    <p style="margin: 0px; background-color: #00FF00; color: #0000FF; font-family: Jokerman; font-size: 26px; font-weight: bold; height: 30px; padding-top: 5px; text-align: center;">-:Television Registration:-</p>
    ...
    <p style="font-family: Jokerman; font-size: x-large; font-weight: bold; color: #0000FF; background-color: #E6E600;height: 25px; padding-top: 5px; text-align: center;">
                -:Add Television Details:-</p>
    </asp:Panel>
    <asp:Panel ID="PanelUpdate" runat="server" Visible="False">
    <p style="font-family: Jokerman; font-size: x-large; font-weight: bold; color: #0000FF; background-color: #E6E600;height: 25px; padding-top: 5px; text-align: center;">
                -:Update Television Details:-</p>
    </asp:Panel>
    <table cellspacing="1" class="style1" style="border: 2px solid #CC0000">
                ...
                <tr style="vertical-align: top">
                    <td>
                        <asp:TextBox ID="Channel1" runat="server" Width="120px" PlaceHolder="Channel Name" />
                    </td>
                    <td>
                        <asp:TextBox ID="Description1" runat="server" Width="150px" 
                            PlaceHolder=" Programm Name" />
                    </td>
                    <td>
                        <asp:TextBox ID="TimeFrom1" runat="server" Width="80px" PlaceHolder="00.00am/pm" />
                    </td>
                    <td>
                        <asp:TextBox ID="TimeTo1" runat="server" Width="80px" PlaceHolder="00.00am/pm" />
                    </td>
                    <td>
                        <asp:TextBox ID="Duration1" runat="server" Width="60px" PlaceHolder="00sec" />
                    </td>
                    <td>
                        <asp:TextBox ID="Repeat1" runat="server" Width="80px" PlaceHolder="1-n" />
                    </td>
                    <td>
                        <asp:TextBox ID="DateFrom1" runat="server" Width="90px" 
                            PlaceHolder="DD/MM/YYYY" />
                    </td>
                    <td>
                        <asp:TextBox ID="Validity1" runat="server" Width="60px" PlaceHolder="00sec" />
                    </td>
                    <td>
        ...
        <AlternatingRowStyle BackColor="White" />
            ...
            <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="Update1" runat="server" Text="Edit" CommandName="UpdateRow1" CommandArgument='<%# Bind("Slno") %>' Font-Size="16px" />
                <br />
                <asp:LinkButton ID="Delete1" runat="server" Text="Delete" CommandName="DeleteRow1" CommandArgument='<%# Bind("Slno") %>' Font-Size="16px"/>
            </ItemTemplate>
            </asp:TemplateField>
            </Columns>
        ...
        SelectCommand="SELECT * FROM [AdminTelevision] WHERE ([Slno] &gt; @Slno)">
                <SelectParameters>
